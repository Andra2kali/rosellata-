...
<body>
	<h1>I LOVE YOU SAYAAANG MUAAAAAAAH </h2>
...
<html>
	<head>
		<body>
			...
			<br><font size="3px">
			<font color="white">[ </font><marquee scrollamount="5" width="630" height="20" behavior="alternate">i love you so muuuuucccccccch sayaaangku rosella </marquee><font color="white"> ]</font>
